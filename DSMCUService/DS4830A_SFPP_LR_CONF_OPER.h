...
#define VALUE_BIAS_MIN_OC		0x0000
#define VALUE_BIAS_MAX_OC		0x0600
#define VALUE_BIAS_DEF_OC		0x0200

#define VALUE_MOD_MIN			0x0000
#define VALUE_MOD_MAX			0x0800
#define VALUE_MOD_DEF			0x0300

#define VALUE_MOD_MIN_OC		0x0000
#define VALUE_MOD_MAX_OC		0x1000
#define VALUE_MOD_DEF_OC		0x0300
...
// ##########################################################################
// CDS4830A_SFPP_LR_CONF_ dialog
// ##########################################################################


class CDS4830A_SFPP_CONF : public CDialogEx
{
	DECLARE_DYNAMIC(CDS4830A_SFPP_CONF)

public:
	CDS4830A_SFPP_CONF(CWnd* pParent = NULL);   // standard constructor
	CDS4830A_SFPP_CONF(HID_SMBUS_DEVICE * pHidSmbus, CProgressCtrl * p_cPB_OP, CEdit * p_EDIT_STATUS, st_serviceData * p_service, CWnd* pParent = NULL);
	
	virtual ~CDS4830A_SFPP_CONF();

// Dialog Data
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_PROPPAGE_DS4830A_SFPP_LR_CONF_OPER };
#endif
...
public:
	...
	BOOL m_bCheck_BIAS_MOD_Dependancy;
	BOOL m_bCheck_SafeRange;
